...
export default class Alien{
    static positionAlien = true; //Booléen qui permet de déterminer la position des aliens
    static missileAliens; // Variable pour le missile des aliens
    static missileAliensTire = false; //Booléen pour le missile des aliens, si il est tiré
    ...
    static moveAlien(aliens){
        ...
        if( box.max.x >= 15 || box.min.x <= -15){
            ...
            if(!Player.isInvincible()){
                aliens.position.z -= 0.1 + Alien.vitesseMissileAlien;
            }
        }
    ...
    static moveMissileAliens = () =>{
        Alien._missileAliens.position.z -= Alien.vitesseMissileAlien;
    ...
    static loadSmokeEffect(){
        ...
        smokeTexture.load("./src/medias/images/smoke.png", function(texture){
            ...
            Alien.particle.position.x = Player.missile.position.x;
            Alien.particle.position.z = Player.missile.position.z;
